...
ext = '.spi';
% read selfile
string=strcat('covar/885/sel_ang.spi');
...
parfor i = 1:size(S,1)
    ...
    string=strcat('covar/885/selfiles/prj_sel_',num2str(j,'%05d'),ext);
    ...
    %test
    % get the 2d cov 
    prj_head = 'covar/885/part_flip/ffsar';
    ...
    prj_head_s = 'covar/885/part_flip/sh_ffsar';
    ...
    out_head = strcat('covar/885/stats/ffnscovar_',type);

...
'''
Copyright (c) Hstau Liao 2018-2019
Copyright (c) Evan Seitz 2018-2019
'''
...
def create_dir():
    ...
    global user_dir,dist_dir,dist_prog,cov_dir,cov_prog, psi_dir,psi_prog,psi2_dir,psi2_prog,\
    ...
    cov_dir = os.path.join(user_dir, 'outputs_{}/covar/'.format(proj_name))
    call(["mkdir", "-p", cov_dir])
    cov_prog = os.path.join(cov_dir, 'progress/')
    call(['mkdir', '-p', cov_prog])
